---
title: "Схематизированные геоизображения"
...
Особный вид схематизированных карт — карты транспортных систем.

```{r, out.width = "100%", fig.cap=""}
knitr::include_graphics("img/talkxx/metro1.png")
```
.vsmall[Bast H. Efficient Generation of Geographically Accurate Transit Maps / H. Bast, P. Brosi, S. Storandt // ACM Transactions on Spatial Algorithms and Systems. – 2019. – Vol. 5. – №4 . – P. 1-36.]

---

## Карты транспортных систем

Важный аспект — минимзация количества пересечений и проведение их под углом, близким к 90 градусов.

```{r, out.width = "100%", fig.cap=""}
knitr::include_graphics("img/talkxx/metro2.png")
```
.vsmall[Bast H. Efficient Generation of Geographically Accurate Transit Maps / H. Bast, P. Brosi, S. Storandt // ACM Transactions on Spatial Algorithms and Systems. – 2019. – Vol. 5. – №4 . – P. 1-36.]
...
Наиболее трудная часть визуализации — распределение линий в транспортных узлах.

```{r, out.width = "100%", fig.cap=""}
knitr::include_graphics("img/talkxx/metro3.png")
```
.vsmall[Bast H. Efficient Generation of Geographically Accurate Transit Maps / H. Bast, P. Brosi, S. Storandt // ACM Transactions on Spatial Algorithms and Systems. – 2019. – Vol. 5. – №4 . – P. 1-36.]
...
Результирающие схемы довольно близки к составленным вручную, хотя и уступают им по качеству.

```{r, out.width = "100%", fig.cap=""}
knitr::include_graphics("img/talkxx/metro4.png")
```
.vsmall[Bast H. Efficient Generation of Geographically Accurate Transit Maps / H. Bast, P. Brosi, S. Storandt // ACM Transactions on Spatial Algorithms and Systems. – 2019. – Vol. 5. – №4 . – P. 1-36.]
